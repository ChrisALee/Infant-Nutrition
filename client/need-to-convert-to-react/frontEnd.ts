...
function main(): void {
    ...
    function createAccount(): void {
        ...
        const lastName: String = document.getElementById('lastName').innerText;
        const email: String = document.getElementById('email').innerText;
